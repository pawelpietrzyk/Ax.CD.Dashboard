...
namespace Web.Client.Rest
{
    ...
    public class Http
    {
        ...
        public static Http post(string url, string data, HttpParams parameters, string contentType = Http.DefaultContentType,  int timeout = 5000)
        {
            return Http.method(HttpMethod.POST, url, data, parameters, contentType, timeout);            
        }        
        ...
        void worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            if (!e.Cancelled)
            {
                if (e.Error == null)
                {
                    ...
                    if (ex != null)
                    {
                        this.callResponseCallback(HttpStatusCode.BadRequest, ex.Message);
                    }
                }
                else
                {
            ...
            {               
                ...
                this.callResponseCallback(HttpStatusCode.BadRequest, "Operation Canceled");             
            }
        }
    ...
    public class HttpResponseEventArgs
    {
        ...
        {
            return String.Format("{0}. {1}", this.StatusCode, this.Content);
        }
    }
